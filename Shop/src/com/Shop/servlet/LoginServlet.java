...
//		System.out.println(id+pwd);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		switch (i) {
		case 1:
			response.sendRedirect("/Shop/login_user.jsp?message=1");
			break;
		case 2:
			response.sendRedirect("/Shop/login_user.jsp?message=2");
			break;
		case 3:
			response.sendRedirect("/Shop/main.jsp?id=" + id + "");
			break;
		case 4:
			response.sendRedirect("/Shop/login_user.jsp?message=4");
			break;
		}
