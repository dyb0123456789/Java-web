...
<body>
	...
	<div class="top1">
		...
		<div class="top-right">
			<ul>
				...
				<li><a
					href="cartShopping.jsp?uId=<%=request.getParameter("id")%>">🛒购物车</a></li>
	...
	<div id="header">
		<div class="header1">
			...
			<div id="myshopping">
				<a href="cartShopping.jsp?uId=<%=request.getParameter("id")%>">
					<img src="img/myshopping.jpg" alt="购物车" title="我的购物车" />
				</a>
			</div>
			<div id="mylogin">
				<form action="#">
	...
	<div class="header-menu">
		<ul>
			...
			<li><a class="a2"
				href="goodslist.jsp?id=<%=request.getParameter("id")%>">今日最新</a>
				<ul>
					<li><a href="">精选女装</a></li>
					<li><a href="">秋装外套</a></li>
					<li><a href="">温暖毛衣</a></li>
	...
	<div class="container">
		<div class="slider">
			<div class="area">
				<div id=js class="js">
					<div class="box01">
						<img onClick="location.href='goodslist.html'"
		...
		<div class="container-right">
			<div class="container1">
				...
				<h4>
					<a href="goodslist.html">蓬蓬裙羽绒服棉衣</a>
				</h4>
