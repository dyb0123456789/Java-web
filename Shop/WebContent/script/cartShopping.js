...
{
	id = iId;
	var url = "Shop/AddSubOneServlet?op="+escape(op)+"&iId="+escape(iId);
...
function setMsg(msg)
{
	if(msg=="null"){
		//减到了0
		//刷新页面
		window.location.href ="http://localhost:8080/Shop/cartShopping.jsp";
		
	}else{
		document.getElementById("div2"+id).innerHTML = "数量:"+msg;
	}
...
function count()
{
	...
	window.location.href = "CountServlet?allItem="+escape(s);
}